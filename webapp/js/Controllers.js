   ...
   App.controller('secondController', function($scope) {
    ...
    App.controller('salaController', function($scope) {
     ...
     App.controller('quartoController', function($scope) {
        $scope.message = 'Quarto';
    });
     App.controller('cozinhaController', function($scope) {
        $scope.message = 'Cozinha';
    });
     App.controller('banheiroController', function($scope) {
        $scope.message = 'Banheiro';
    });
